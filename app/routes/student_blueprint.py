...
from app.controllers.student_controller import deleting_student, deleting_subject, get_all_students, get_info_student, registering_student, updating_address, updating_student
...
bp_student.get('')(jwt_required()(get_info_student))
